...
#load df
df = pd.read_csv('data/2016_president_clean.csv', index_col=0)
...
plt.savefig('image/2016_president_barChart.png', dpi=300, bbox_inches='tight')
plt.show()