...
# 讀取 CSV
df = pd.read_csv("data/2008_president_detail_clean.csv")
...
plt.title('2008 總統選舉：勝選候選人+得票深淺熱力圖', fontsize=20)
ax.axis('off')
...
plt.savefig('image/2008_president_detail_map.png', dpi=300, bbox_inches='tight')
plt.show()
