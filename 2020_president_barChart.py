...
#load df
df = pd.read_csv('data/2020_president_clean.csv', index_col=0)
...
bar = ax.bar(x=df.index, height=df['votes'], color=df['color'], width=0.5)
...
plt.savefig('image/2020_president_barChart.png', dpi=300, bbox_inches='tight')
plt.show()