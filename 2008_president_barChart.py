...
#load df
df = pd.read_csv('data/2008_president_clean.csv', index_col=0)
...
plt.savefig('image/2008_president_barChart.png', dpi=300, bbox_inches='tight')
plt.show()